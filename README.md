...
現在は **12時間おき（JST 08:00 / 20:00）**。

> Streamlit は 15時間 放置すると寝ていた（実測: 4件中3件）。
> 1日1回では足りないため 12時間おきにしている。
...
| 間隔 | cron | JST |
|---|---|---|
| **12時間おき** | **`0 11,23 * * *`** | **08:00 / 20:00** |
| 8時間おき | `0 7,15,23 * * *` | 08:00 / 16:00 / 00:00 |
| 6時間おき | `0 5,11,17,23 * * *` | 02:00 / 08:00 / 14:00 / 20:00 |
| 4時間おき | `0 3,7,11,15,19,23 * * *` | — |
| 1日1回 | `0 23 * * *` | 08:00 |

分を変える場合は先頭の数字（JST 08:30 / 20:30 → `30 11,23 * * *`）。
